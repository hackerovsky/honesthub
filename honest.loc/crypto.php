...
<head>
  ...
  <title>Криптовалюта - Honest - социальная сеть для предпренимателей</title>
      ...
      <div class="container">
        <div class="m-menu__inner">
          <div class="m-menu__list">
            ...
            <a href="/crypto" class="m-menu__item is-active">Криптовалюта</a>
        ...
        <div class="header__inner">
          <div class="header__nav">
            <div class="header__nav-list js-nav-list">
              ...
              <div class="header__nav-item">
                <a href="/crypto" class="header__nav-btn js-nav-item is-active">Криптовалюта</a>
              </div>
              <div class="header__nav-item">
              ...
              <div class="block__inner widget widget-quote">
                ...
                <div class="widget__body">
                  <div class="widget-quote__text">
                    <p>Если мир кажется Вам холодным, разожгите огни чтобы сделать его теплее!</p>
                  </div>
                  <div class="widget-quote__author">Люси Ларком</div>
                </div>
              </div>
            </div>
            ...
            <div class="block">
              <div class="block__inner">
                <div class="block__content">
                  <div class="crypto">
                    <div class="crypto__head">
                      <div class="crypto__head-title">EPPAS</div>
                      <div class="crypto__head-subtitle">$311.26</div>
                      <div class="crypto__head-subtitle">+1,08 (0,08%)</div>
                    </div>
                    <div class="crypto__subhead">
                      <div class="crypto__subhead-title">на 16 октября, 18:04</div>
                    </div>
                    <div class="crypto__content">
                      <div class="crypto__content-row">
                        <div class="crypto__content-col">
                          <div class="crypto__content-title">Купить Eppas</div>
                          <div class="crypto__content-input-label">Количество</div>
                          <div class="crypto__content-input">
                            <input type="text" value="1" class="crypto__content-input-control">
                          </div>
                          <div class="crypto__content-input-label">Цена</div>
                          <div class="crypto__content-input">
                            <input type="text" value="311.26" class="crypto__content-input-control">
                            <div class="crypto__content-input-control-block">
                              <div class="crypto__content-input-control-label">$</div>
                              <div class="crypto__content-input-control-btns">
                                <div class="crypto__content-input-control-btn rotate--180">
                                  <svg class="svg-icon">
                                    <use xlink:href="#i-chevron"></use>
                                  </svg>
                                </div>
                                <div class="crypto__content-input-control-btn">
                                  <svg class="svg-icon">
                                    <use xlink:href="#i-chevron"></use>
                                  </svg>
                                </div>
                          ...
                          <div class="crypto__content-btn hover">Купить</div>
                        </div>
                        <div class="crypto__content-col">
                          <div class="crypto__content-title">Продать Eppas</div>
                          <div class="crypto__content-input-label">Количество</div>
                          <div class="crypto__content-input">
                            <input type="text" value="1" class="crypto__content-input-control">
                          </div>
                          ...
                          <div class="crypto__content-btn hover">Продать</div>
                        </div>
                      </div>
                    </div>
                  </div>
