...
<head>
  ...
  <title>Мотивация - Honest - социальная сеть для предпренимателей</title>
      ...
      <div class="container">
        <div class="m-menu__inner">
          <div class="m-menu__list">
            ...
            <a href="/motivation" class="m-menu__item is-active">Мотивация</a>
        ...
        <div class="header__inner">
          <div class="header__nav">
            <div class="header__nav-list js-nav-list">
              ...
              <div class="header__nav-item">
                <a href="/motivation" class="header__nav-btn js-nav-item is-active">Мотивация</a>
              </div>
              <div class="header__nav-item">
    ...
    <div class="content">
      <div class="container">
        <div class="content__row">
          <div class="content__col content__col--sidebar order--1 hide-m">
            <div class="block">
              <div class="block__inner block__inner--nolrpdtbpd10 widget widget-nav">
                <div class="widget__body">
                  <a href="#" class="widget-nav__item is-active">Популярное</a>
                  <a href="#" class="widget-nav__item">Новое</a>
                  <a href="#" class="widget-nav__item">Рекомендации</a>
                </div>
              </div>
            </div>
          </div>
          <div class="content__col content__col--sidebar order--3 order--m-1">
              ...
              <div class="block__inner widget widget-quote">
                ...
                <div class="widget__body">
                  <div class="widget-quote__text">
                    <p>Мы должны вызывать, а не ждать вдохновения, чтобы начать дело. Действие всегда порождает вдохновение. Вдохновение редко порождает действие.</p>
                  </div>
                  <div class="widget-quote__author">Фрэнк Тиболт</div>
                </div>
              </div>
            </div>
          ...
          <div class="content__col content__col--main order--2 order--m-2">
            <div class="block">
              <div class="block__inner">
                <div class="block__content">
                  <div class="motivation-item">
                    <div class="motivation-item__head">
                      <div class="motivation-item__head-info">
                        <div class="motivation-item__head-title hover">Альберт Струсовский</div>
                        <div class="motivation-item__head-subtitle">два дня назад</div>
                      </div>
                      <div class="motivation-item__head-more hover">
                        <svg class="svg-icon">
                          <use xlink:href="#i-more"></use>
                        </svg>
                      </div>
                    </div>
                    <div class="motivation-item__content">
                      <div class="motivation-item__big-link hover">
                        <div class="motivation-item__big-link-ico">
                          <svg class="svg-icon">
                            <use xlink:href="#i-play"></use>
                          </svg>
                        </div>
                        <div class="motivation-item__big-link-label">Джиа джианг: иммунитет к отказам и стрессовым ситуациям</div>
                      </div>
                      <div class="motivation-item__text">Когда вас отвергают, когда вас постигает неудача или вы сталкиваетесь с трудностями, подумайте об открывающихся перспективах, не бегите, примите ситуацию и тогда сложности обернутся возможностями.</div>
                      <div class="motivation-item__pic">
                        <img src="assets/img/motivation/motivate_1.jpg" alt="Мотивация">
                      </div>
                    </div>
                    <div class="motivation-item__actions">
                      <div class="motivation-item__actions-left">
                        <div class="motivation-item__actions-item hover">
                          <div class="motivation-item__actions-icon">
                            <svg class="svg-icon">
                              <use xlink:href="#i-like"></use>
                            </svg>
                          </div>
                          <div class="motivation-item__actions-label">116</div>
                        </div>
                        <div class="motivation-item__actions-item hover">
                          <div class="motivation-item__actions-icon">
                            <svg class="svg-icon">
                          ...
                          <div class="motivation-item__actions-label">21</div>
                        </div>
                        <div class="motivation-item__actions-item hover">
                          <div class="motivation-item__actions-icon">
                            <svg class="svg-icon">
                          ...
                          <div class="motivation-item__actions-label">8</div>
                        </div>
                      </div>
                      <div class="motivation-item__actions-right">
                        <div class="motivation-item__actions-item">
                          <div class="motivation-item__actions-icon">
                            <svg class="svg-icon">
                              <use xlink:href="#i-view"></use>
                            </svg>
                          </div>
                          <div class="motivation-item__actions-label">689</div>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="block__inner">
                <div class="block__content">
                  <div class="motivation-item">
                    <div class="motivation-item__head">
                      <div class="motivation-item__head-info">
                        <div class="motivation-item__head-title hover">Магомед Евлоев</div>
                        <div class="motivation-item__head-subtitle">четыре месяца назад</div>
                      </div>
                      <div class="motivation-item__head-more hover">
                        <svg class="svg-icon">
                          <use xlink:href="#i-more"></use>
                    ...
                    <div class="motivation-item__content">
                      <div class="motivation-item__big-link hover">
                        ...
                        <div class="motivation-item__big-link-label">О пользе неудач и черной полосы в жизни</div>
                      </div>
                      <div class="motivation-item__text">
Брюс Гриерсон (Bruce Grierson) считает, что неудачи на пути к успеху играют свою важную роль. В статье «Переживая непогоду» (Weathering th Storm) он приводит яркие примеры, свидетельствующие о пользе неудач. Давайте познакомимся с конспектом этой статьи.</div>
                      <div class="motivation-item__pic">
                        <img src="assets/img/motivation/motivate_2.jpg" alt="Мотивация">
                      </div>
                    </div>
                    <div class="motivation-item__actions">
                      <div class="motivation-item__actions-left">
                        <div class="motivation-item__actions-item hover">
                          ...
                          <div class="motivation-item__actions-label">136</div>
                        </div>
                        <div class="motivation-item__actions-item hover">
                          <div class="motivation-item__actions-icon">
                            <svg class="svg-icon">
                          ...
                          <div class="motivation-item__actions-label">22</div>
                        </div>
                        <div class="motivation-item__actions-item hover">
                          <div class="motivation-item__actions-icon">
                            <svg class="svg-icon">
                          ...
                          <div class="motivation-item__actions-label">12</div>
                        </div>
                      </div>
                      <div class="motivation-item__actions-right">
                        <div class="motivation-item__actions-item">
                          ...
                          <div class="motivation-item__actions-label">222</div>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="content__col content__col--sidebar order--4 order--m-3">
