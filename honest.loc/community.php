...
<head>
  ...
  <title>Сообщества - Honest - социальная сеть для предпренимателей</title>
      ...
      <div class="container">
        <div class="m-menu__inner">
          <div class="m-menu__list">
            ...
            <a href="/community" class="m-menu__item is-active">Сообщества</a>
        ...
        <div class="header__inner">
          <div class="header__nav">
            <div class="header__nav-list js-nav-list">
              ...
              <div class="header__nav-item">
                <a href="/community" class="header__nav-btn js-nav-item is-active">Сообщества</a>
              </div>
              <div class="header__nav-item">
    ...
    <div class="content">
      <div class="container">
        <div class="content__row">
          <div class="content__col content__col--bigmain order--2 order--m-1">
          <div class="block">
              <div class="block__inner block__inner--pdt24">
                <div class="block__content partners">
                  <div class="partners__head">
                    <div class="partners__head-title">Сообщества</div>
                    <div class="partners__head-action hover">
                      <div class="partners__head-action-icon">
                        <svg class="svg-icon">
                  ...
                  <div class="community__list">
                    <div class="community__item">
                      <div class="community__item-content">
                        <div class="community__item-avatar hover">
                          <img src="/assets/img/comm/networking.jpg" alt="Нетворкинг">
                        </div>
                        <div class="community__item-info">
                          <div class="community__item-title hover">Нетворкинг</div>
                          <div class="community__item-subtitle">22 220 участников</div>
                          <div class="community__item-subtext">Сообщество для заведения бизнес знакомст. В основе понятия «нетворкинг» лежит так называемая теория шести рукопожатий...</div>
                        </div>
                      </div>
                      <div class="community__item-actions">
                        <div class="community__item-btn hover">Подписаться</div>
                        <div class="community__item-btn hover community__item-btn--bd">Открыть</div>
                      </div>
                    </div>
                    <div class="community__item">
                      <div class="community__item-content">
                        <div class="community__item-avatar hover">
                          <img src="/assets/img/comm/mentor.jpg" alt="Менторство">
                        </div>
                        <div class="community__item-info">
                          <div class="community__item-title hover">Менторство</div>
                          <div class="community__item-subtitle">2200 участников</div>
                          <div class="community__item-subtext">Сообщество наставников и поднаставных. Ищите и находите.</div>
                        </div>
                      </div>
                      <div class="community__item-actions">
                        <div class="community__item-btn hover">Подписаться</div>
                    ...
                    <div class="community__item">
                      <div class="community__item-content">
                        <div class="community__item-avatar hover">
                          <img src="/assets/img/comm/vc.jpg" alt="VC">
                        </div>
                        <div class="community__item-info">
                          <div class="community__item-title hover">VC.ru</div>
                          <div class="community__item-subtitle">740 участников</div>
                          <div class="community__item-subtext">Крупнейшая в рунете площадка для предпринимателей нового поколения. Новости ИТ-рынка, вакансии рунета, реклама, PR, интерфейсы, мобильные приложения.</div>
                        </div>
                      </div>
                      <div class="community__item-actions">
                        <div class="community__item-btn hover">Подписаться</div>
                    ...
                    <div class="community__item">
                      <div class="community__item-content">
                        <div class="community__item-avatar hover">
                          <img src="/assets/img/comm/rbk.jpg" alt="RBK">
                        </div>
                        <div class="community__item-info">
                          <div class="community__item-title hover">РБК</div>
                          <div class="community__item-subtitle">16 210 участников</div>
                          <div class="community__item-subtext">Российский медиахолдинг, включающий одноимённый телеканал, информационное агентство, газету и журнал.</div>
                        </div>
                      </div>
                      <div class="community__item-actions">
                        <div class="community__item-btn hover">Подписаться</div>
                    ...
                    <div class="community__item">
                      <div class="community__item-content">
                        <div class="community__item-avatar hover">
                          <img src="/assets/img/comm/tj.jpg" alt="TJournal">
                        </div>
                        <div class="community__item-info">
                          <div class="community__item-title hover">TJournal</div>
                          <div class="community__item-subtitle">1260 участников</div>
                          <div class="community__item-subtext">Онлайн-издание о технологиях и трендах "TJournal". Публикации популярных материалов из социальных сетей и твитов. Колонки экспертов интернет-рынка, онлайн-трансляции IT-конференций.</div>
                        </div>
                      </div>
                      <div class="community__item-actions">
                        <div class="community__item-btn hover">Подписаться</div>
          ...
          <div class="content__col content__col--sidebar order--1 order--m-2">

            <div class="block">
              <div class="block__inner block__inner--nolrpdtbpd10 widget widget-nav">
                <div class="widget__body">
                  <a href="#" class="widget-nav__item is-active">Мои сообщества</a>
                  <a href="#" class="widget-nav__item">Рекомендации</a>
                  <a href="#" class="widget-nav__item">Новые</a>
                </div>
              </div>
            </div>

            <div class="block block--noshadow block--transbg show-m">
          ...
          <div class="content__col content__col--sidebar order--3 order--m-3 hide-m">

            <div class="block block--noshadow block--transbg show">
              <div class="sidebar-links">
                <a href="#" class="sidebar-links__item hover">Политика конфиденциальности</a>
                <a href="#" class="sidebar-links__item hover">Условия использования</a>
                <a href="#" class="sidebar-links__item hover">Реклама</a>
