...
<head>
  ...
  <title>Маркет - Honest - социальная сеть для предпренимателей</title>
      ...
      <div class="container">
        <div class="m-menu__inner">
          <div class="m-menu__list">
            ...
            <a href="/store" class="m-menu__item is-active">Маркет</a>
        ...
        <div class="header__inner">
          <div class="header__nav">
            <div class="header__nav-list js-nav-list">
              ...
              <div class="header__nav-item">
                <a href="/store" class="header__nav-btn js-nav-item is-active">Маркет</a>
              </div>
              <div class="header__nav-item">
                  ...
                  <div class="startups__list">
                    <div class="startups__item">
                      ...
                      <div class="startups__item-right">
                        <div class="startups__item-price-label">Стоимость</div>
            ...
            <div class="block">
              <div class="block__inner block__inner--nolrpdtbpd10 widget widget-nav">
                <div class="widget__body">
                  ...
                  <a href="#" class="widget-nav__item">Продажа</a>
                  <a href="#" class="widget-nav__item">Ваши лоты</a>
                </div>
              </div>
            </div>
