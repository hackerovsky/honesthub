...
<head>
  ...
  <title>Инвестиции - Honest - социальная сеть для предпренимателей</title>
      ...
      <div class="container">
        <div class="m-menu__inner">
          <div class="m-menu__list">
            ...
            <a href="/investments" class="m-menu__item is-active">Инвестиции</a>
        ...
        <div class="header__inner">
          <div class="header__nav">
            <div class="header__nav-list js-nav-list">
              ...
              <div class="header__nav-item">
                <a href="/investments" class="header__nav-btn js-nav-item is-active">Инвестиции</a>
              </div>
              <div class="header__nav-item">
          ...
          <div class="content__col content__col--bigmain order--2 order--m-1">
            <div class="block">
              <div class="block__inner">
                <div class="block__content investments">
                  <div class="investments__title">Мои инвестиции</div>
                  <div class="investments__sort">
                    <div class="investments__sort-label">Сортировка:</div>
                    <div class="investments__sort-value hover">По дате</div>
                    <div class="investments__sort-value hover">По сумме</div>
                  </div>
                  <div class="investments__list">
                    <div class="investments__item">
                      <div class="investments__item-left">
                        <div class="investments__item-user-info hover">
                          <div class="investments__item-user-avatar">
                            <img src="/assets/img/profile/avatar_blank.png" alt="Алексей Ларионов">
                          </div>
                          <div class="investments__item-user-title">Алексей Ларионов</div>
                        </div>
                        <div class="investments__item-text">Магазин строительных инструментов “Молоток”</div>
                      </div>
                      <div class="investments__item-right">
                        <div class="investments__item-price">100 000 Р</div>
                        <div class="investments__item-price-label">Ежемесячная прибль</div>
                        <div class="investments__item-price">7 000 Р</div>
                      </div>
                    </div>
                    <div class="investments__item">
                      <div class="investments__item-left">
                        <div class="investments__item-user-info hover">
                          <div class="investments__item-user-avatar">
                            <img src="/assets/img/profile/avatar_blank.png" alt="Валерий Вариконов">
                          </div>
                          <div class="investments__item-user-title">Валерий Вариконов</div>
                        </div>
                        <div class="investments__item-text">Сеть магазинов надувных игрушек “Облако”</div>
                      </div>
                      <div class="investments__item-right">
                        <div class="investments__item-price">200 000 Р</div>
                        <div class="investments__item-price-label">Ежемесячная прибль</div>
                        <div class="investments__item-price">15 000 Р</div>
                      </div>
                    </div>
                    <div class="investments__item">
                      <div class="investments__item-left">
                        <div class="investments__item-user-info hover">
                          <div class="investments__item-user-avatar">
                            <img src="/assets/img/profile/avatar_blank.png" alt="Виталий Совков">
                          </div>
                          <div class="investments__item-user-title">Виталий Совков</div>
                        </div>
                        <div class="investments__item-text">Сервис очистных работ “Чистюля”</div>
                      </div>
                      <div class="investments__item-right">
                        <div class="investments__item-price">120 000 Р</div>
                        <div class="investments__item-price-label">Ежемесячная прибль</div>
                        <div class="investments__item-price">9 000 Р</div>
                      </div>
                    </div>
                    <div class="investments__item">
                      <div class="investments__item-left">
                        <div class="investments__item-user-info hover">
                          <div class="investments__item-user-avatar">
                            <img src="/assets/img/profile/avatar_blank.png" alt="Николай Псковский">
                          </div>
                          <div class="investments__item-user-title">Николай Псковский</div>
                        </div>
                        <div class="investments__item-text">Катамараны напрокат “Кировские”</div>
                      </div>
                      <div class="investments__item-right">
                        <div class="investments__item-price">330 000 Р</div>
                        <div class="investments__item-price-label">Ежемесячная прибль</div>
                        <div class="investments__item-price">22 000 Р</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="block">
              <div class="block__inner block__inner--nolrpdtbpd10 widget widget-nav">
                <div class="widget__body">
                  <a href="#" class="widget-nav__item is-active">Мои инвестиции</a>
                  <a href="#" class="widget-nav__item">Мои цели</a>
                  <a href="#" class="widget-nav__item">Рекомендации</a>
                  <a href="#" class="widget-nav__item">Нуждающиеся</a>
                </div>
              </div>
            </div>
