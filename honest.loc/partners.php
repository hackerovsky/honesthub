...
<head>
  ...
  <title>Партнеры - Honest - социальная сеть для предпренимателей</title>
      ...
      <div class="container">
        <div class="m-menu__inner">
          <div class="m-menu__list">
            ...
            <a href="/partners" class="m-menu__item is-active">Партнеры</a>
        ...
        <div class="header__inner">
          <div class="header__nav">
            <div class="header__nav-list js-nav-list">
              ...
              <div class="header__nav-item">
                <a href="/partners" class="header__nav-btn js-nav-item is-active">Партнеры</a>
              </div>
              <div class="header__nav-item">
              ...
              <div class="block__inner widget widget-quote">
                ...
                <div class="widget__body">
                  <div class="widget-quote__text">
                    <p>Если вы хотите быть более удачливым, делайте больше попыток.</p>
                  </div>
                  <div class="widget-quote__author">Брайан Трейси</div>
                </div>
              </div>
            </div>
              ...
              <div class="block__inner block__inner--pdt24">
                <div class="block__content partners">
                  <div class="partners__head">
                    <div class="partners__head-title">Мои партнеры</div>
                  ...
                  <div class="partners__list">
                    ...
                    <div class="partners__item">
                      <div class="partners__item-content">
                        <div class="partners__item-avatar hover">
                          <img src="/assets/img/profile/avatar_blank_big.png" alt="Маргарита Васильева">
                        </div>
                        <div class="partners__item-info">
                          <div class="partners__item-title hover"><?=$partner['names']?></div>
                          <div class="partners__item-subtitle"><?=$partner['company']?></div>
                        </div>
                      </div>
                      <div class="partners__item-actions">
                        <div class="partners__item-btn hover">Написать</div>
                        <div class="partners__item-btn hover partners__item-btn--bd">Удалить</div>
                      </div>
                    </div>
                    <? endforeach; ?>
                  </div>
