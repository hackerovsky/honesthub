...
<head>
  ...
  <title>Стартапы - Honest - социальная сеть для предпренимателей</title>
      ...
      <div class="container">
        <div class="m-menu__inner">
          <div class="m-menu__list">
            ...
            <a href="/startups" class="m-menu__item is-active">Стартапы</a>
        ...
        <div class="header__inner">
          <div class="header__nav">
            <div class="header__nav-list js-nav-list">
              ...
              <div class="header__nav-item">
                <a href="/startups" class="header__nav-btn js-nav-item is-active">Стартапы</a>
              </div>
              <div class="header__nav-item">
          ...
          <div class="content__col content__col--bigmain order--2 order--m-1">
            <div class="block">
              <div class="block__inner">
                <div class="block__content startups">
                  <div class="startups__title">Мои стартапы</div>
                  <div class="startups__sort">
                    <div class="startups__sort-label">Сортировка:</div>
                    <div class="startups__sort-value hover">По дате</div>
                    <div class="startups__sort-value hover">По бюджету</div>
                  </div>
                  <div class="startups__list">
                    <div class="startups__item">
                      <div class="startups__item-left">
                        <div class="startups__item-user-topinfo hover">
                          <div class="startups__item-user-topavatar">
                            <img src="/assets/img/startups/scrum.png" alt="Scrum Tim">
                          </div>
                          <div class="startups__item-user-toptitle">Scrum Time</div>
                        </div>
                        <div class="startups__item-user-info hover">
                          <div class="startups__item-user-avatar">
                            <img src="/assets/img/profile/avatar_blank.png" alt="Алексей Ларионов">
                          </div>
                          <div class="startups__item-user-title">Алексей Ларионов</div>
                        </div>
                        <div class="startups__item-text">Система управления проектами из Омска</div>
                      </div>
                      <div class="startups__item-right">
                        <div class="startups__item-price-label">Требуемый бюджет</div>
                        <div class="startups__item-price">1 000 000 Р</div>
                        <div class="startups__item-price-label">Прогнозируемая прибль</div>
                        <div class="startups__item-price">700 000 Р / мес</div>
                      </div>
                    </div>
                    <div class="startups__item">
                      <div class="startups__item-left">
                        <div class="startups__item-user-topinfo hover">
                          <div class="startups__item-user-topavatar">
                            <img src="/assets/img/startups/ejourny.jpg" alt="Enjourney.ru">
                          </div>
                          <div class="startups__item-user-toptitle">Enjourney.ru</div>
                        </div>
                        <div class="startups__item-user-info hover">
                          <div class="startups__item-user-avatar">
                            <img src="/assets/img/profile/avatar_blank.png" alt="Василий Косилов">
                          </div>
                          <div class="startups__item-user-title">Василий Косилов</div>
                        </div>
                        <div class="startups__item-text">Enjourney.ru– социальная сеть для любителей путешествовать</div>
                      </div>
                      <div class="startups__item-right">
                        <div class="startups__item-price-label">Требуемый бюджет</div>
                        <div class="startups__item-price">1 500 000 Р</div>
                        <div class="startups__item-price-label">Прогнозируемая прибль</div>
                        <div class="startups__item-price">600 000 Р / мес</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="block">
              <div class="block__inner block__inner--nolrpdtbpd10 widget widget-nav">
                <div class="widget__body">
                  <a href="#" class="widget-nav__item is-active">Новые</a>
                  <a href="#" class="widget-nav__item">Рекомендации</a>
                  <a href="#" class="widget-nav__item">Топовые</a>
                </div>
              </div>
            </div>
