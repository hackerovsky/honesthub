...
require_once 'handlers/get_data_all.php';
?>
...
<head>
  ...
  <title>Обучение - Honest - социальная сеть для предпренимателей</title>
      ...
      <div class="container">
        <div class="m-menu__inner">
          <div class="m-menu__list">
            ...
            <a href="/education" class="m-menu__item is-active">Обучение</a>
        ...
        <div class="header__inner">
          <div class="header__nav">
            <div class="header__nav-list js-nav-list">
              ...
              <div class="header__nav-item">
                <a href="/education" class="header__nav-btn js-nav-item is-active">Обучение</a>
              </div>
              <div class="header__nav-item">
    ...
    <div class="content">
      <div class="container">
        <div class="content__row">
          <div class="content__col content__col--sidebar order--m-1 order--2">
              ...
              <div class="block__inner widget widget-quote">
                ...
                <div class="widget__body">
                  <div class="widget-quote__text">
                    <p>Раз в жизни фортуна стучится в дверь каждого человека, но человек в это время нередко сидит в ближайшей пивной и никакого стука не слышит.</p>
                  </div>
                  <div class="widget-quote__author">Марк Твен</div>
                </div>
              </div>
            </div>
          ...
          <div class="content__col content__col--bigmain order--m-2 order--1">
            <div class="block">
              <div class="block__inner block__inner--pdt24">
                <div class="block__content partners">
                  <div class="partners__head">
                    <div class="partners__head-title">Моё обучение</div>
                  ...
                  <div class="education__list">
                    <div class="education__item">
                      <div class="education__item-content">
                        <div class="education__item-avatar hover">
                          <img src="/assets/img/education/hakamaton.jpg" alt="Хакаматон">
                        </div>
                        <div class="education__item-info">
                          <div class="education__item-title hover">Хакаматон (20 уроков, 15 заданий)</div>
                          <div class="education__item-subtitle">От: Ирина Хакамада</div>
                          <div class="education__item-sublabel">Курс включает в себя:</div>
                          <div class="education__item-sublist">
                            <div class="education__item-subitem">Видео</div>
                            <div class="education__item-subitem">Аудиотреки</div>
                            <div class="education__item-subitem">Статьи</div>
                            <div class="education__item-subitem">Практические задания</div>
                          </div>
                        </div>
                      </div>
                      <div class="education__item-actions">
                        <div class="education__item-btn hover">Проходить</div>
                        <div class="education__item-btn hover education__item-btn--bd">Подробнее</div>
                      </div>
                    </div>
                    <div class="education__item">
                      <div class="education__item-content">
                        <div class="education__item-avatar hover">
                          <img src="/assets/img/education/jetbrains.jpg" alt="Jet Brains">
                        </div>
                        <div class="education__item-info">
                          <div class="education__item-title hover">HTML, CSS, JS - научись делать сайты</div>
                          <div class="education__item-subtitle">От: JetBrains</div>
                          <div class="education__item-sublabel">Курс включает в себя:</div>
                          <div class="education__item-sublist">
                            <div class="education__item-subitem">Видео</div>
                            <div class="education__item-subitem">Статьи</div>
