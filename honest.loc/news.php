...
<head>
  ...
  <title>Новости - Honest - социальная сеть для предпренимателей</title>
    ...
    <div class="m-menu js-menu">
      <div class="container">
        ...
        <div class="m-menu__list">
            ...
            <a href="/news" class="m-menu__item is-active">Новости</a>
        ...
        <div class="header__inner">
          <div class="header__nav">
            <div class="header__nav-list js-nav-list">
              ...
              <div class="header__nav-item">
                <a href="/news" class="header__nav-btn js-nav-item is-active">Новости</a>
              </div>
              <div class="header__nav-item">
              ...
              <div class="block__inner widget widget-quote">
                ...
                <div class="widget__body">
                  <div class="widget-quote__text">
                    <p>Я не верю в то, что кто-то может выполнять сегодняшнюю работу вчерашними методами и остаться в
                      бизнесе завтра. </p>
                  </div>
                  <div class="widget-quote__author">Нельсон Джексон</div>
                </div>
              </div>
            </div>
                  ...
                  <div class="news-item">
                    <div class="news-item__head">
                      ...
                      <div class="news-item__head-info">
                        <div class="news-item__head-title hover">Виктор Николаев</div>
                        <div class="news-item__head-subtitle">два дня назад</div>
                      </div>
                    ...
                    <div class="news-item__content">
                      ...
                      Платежная система запустила программу Mastercard Accelerate. Теперь ее участники смогут создавать свои пластиковые карты, при помощи которых можно будет покупать, хранить и тратить как фиатные, так и цифровые валюты
                      </div>
                      <div class="news-item__pic">
                        <img src="assets/img/news/news_3.jpg" alt="Новость">
                      </div>
                      <a href="#" class="news-item__link">Mastercard выпустит криптовалютную карту для Wirex</a>
                    ...
                    <div class="news-item__actions">
                      <div class="news-item__actions-left">
                        <div class="news-item__actions-item hover">
                          ...
                          <div class="news-item__actions-label">222</div>
                        </div>
                        <div class="news-item__actions-item hover">
                          <div class="news-item__actions-icon">
                            <svg class="svg-icon">
                          ...
                          <div class="news-item__actions-label">13</div>
                        </div>
                        <div class="news-item__actions-item hover">
                          <div class="news-item__actions-icon">
                            <svg class="svg-icon">
                          ...
                          <div class="news-item__actions-label">16</div>
                        </div>
                      </div>
                      <div class="news-item__actions-right">
                        <div class="news-item__actions-item">
                          ...
                          <div class="news-item__actions-label">721</div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="news-item__comments-item">
                        <div class="comment">
                          ...
                          <div class="comment__content">
                            <div class="comment__title hover">Николай</div>
                            <div class="comment__text">Об этом говорили еще в 2018...</div>
                  ...
                  <div class="news-item">
                    <div class="news-item__head">
                      ...
                      <div class="news-item__head-info">
                        ...
                        <div class="news-item__head-subtitle">три месяца назад</div>
                      </div>
